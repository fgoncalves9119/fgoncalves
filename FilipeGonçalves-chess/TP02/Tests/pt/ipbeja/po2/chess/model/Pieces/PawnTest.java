...
class PawnTest {
    ...
    void possibleMoves() {
        ...
        dataBoard[3][3] = new Pawn(gameModel, PlayerColor.Black, new Position(3,3));

        this.gameModel.setDataBoard(dataBoard);

        List<Position> expected = Arrays.asList(new Position(4,3));
    ...
    void possibleTakes() {
        ...
        List<Position> expected = Arrays.asList(new Position(4,2), new Position(4,4));
    ...
    void movementText() {
        ...
        assertEquals(null, this.gameModel.getPiece(4,3));

        this.gameModel.clickPiece(3,3);
        this.gameModel.clickPiece(4,3);
